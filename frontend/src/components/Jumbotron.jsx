export function Jumbotron() {
    ...
    return (
        <div className='jumbotron z-20 flex flex-col w-full mx-auto gap-2 md:gap-6 p-20 sm:py-20 md:py-24 lg:py-32 justify-center'>
            ...
            <button className='max-w-[300px] mx-auto text-md sm:text-md md:text-lg lg:text-lg font-bold bg-[#152947] text-white px-4 py-2 rounded-full hover:bg-slate-800 ease-in-out duration-300'>Start Prediction</button>
        </div>
    )
}