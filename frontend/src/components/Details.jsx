    ...
    return (
        <div className='flex flex-wrap mx-auto gap-8'>
            <div className='flex flex-wrap w-3/4 justify-center mx-auto m-8'>
                <div className='background-img w-[300px] h-[300px] border-4 rounded-2xl m-6'></div>
                <div className='flex flex-col w-1/2 justify-center gap-2 m-4'>
                    <h2 className='text-3xl font-extrabold text-[#1b3e72]'>Background</h2>
            ...
            <div className='flex flex-wrap w-full justify-center mx-auto m-8'>
                <div className='flex flex-col w-1/2 justify-center'>
                    <h2 className='text-3xl font-extrabold text-[#1b3e72] text-right mr-4 mb-2'>Benefit</h2>
                    <hr className='border-2 border-[#72a2c9] w-1/2 rounded-full ml-auto mr-4'/>
                    <div className='flex flex-wrap justify-end m-4 gap-4'>
                ...
                <div className='benefit-img w-[300px] h-[300px] border-4 rounded-2xl m-6'></div>
            </div>
        </div>
    )
}